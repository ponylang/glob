...
You want to contribute to glob? Awesome.
...
First of all please [search existing issues](https://github.com/ponylang/glob/issues) to make sure your issue hasn't already been reported. If you cannot find a suitable issue — [create a new one](https://github.com/ponylang/glob/issues/new).
